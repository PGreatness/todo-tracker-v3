    ...
    return (
        <div className='table ' >
            <TableHeader
                ...
                clear={props.clear} undo={props.undo} redo={props.redo}
                canUndo={props.canUndo} canRedo={props.canRedo}
                sortDesc={props.descSort}
                sortDate={props.dateSort}
                sortStatus={props.statusSort}
                sortAssigned={props.assignedSort}
                sorts={props.sorts}
            />
            <TableContents
